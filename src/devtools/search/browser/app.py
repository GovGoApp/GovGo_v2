...
HOMOLOGATION_ROOT = PROJECT_ROOT / "src" / "devtools" / "search"
...
ACTIVE_SEARCH_ROOT = PROJECT_ROOT / "src" / "backend" / "search" / "v1_copy" / "gvg_browser"
...
from src.devtools.browser_design import get_browser_design_css
