...
SEARCH_DEVTOOLS_ROOT = PROJECT_ROOT / "src" / "devtools" / "search"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--fixtures",
        default=str(SEARCH_DEVTOOLS_ROOT / "fixtures" / "search_cases.json"),
    )
    parser.add_argument(
        "--output",
        default=str(SEARCH_DEVTOOLS_ROOT / "artifacts" / "smoke_search_latest.json"),
    )
    return parser
