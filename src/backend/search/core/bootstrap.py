...
def resolve_v1_search_root() -> Path:
    ...
    candidates = []
    candidates.append(get_v2_root() / "src" / "backend" / "search" / "v1_copy" / "gvg_browser")
    if env_path:
    ...
    raise FileNotFoundError(
        "Nao foi possivel localizar uma copia local de src/backend/search/v1_copy/gvg_browser "
