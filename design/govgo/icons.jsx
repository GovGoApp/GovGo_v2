...
const Icon = {
  ...
  pageFirst:   (p) => <I {...p}><path d="M5 5v10M14 5l-5 5 5 5"/></I>,
  pagePrev:    (p) => <I {...p}><path d="m12.5 5-5 5 5 5"/></I>,
  pageNext:    (p) => <I {...p}><path d="m7.5 5 5 5-5 5"/></I>,
  pageLast:    (p) => <I {...p}><path d="M15 5v10M6 5l5 5-5 5"/></I>,
  ...
  copy:        (p) => <I {...p}><rect x="7" y="6" width="9" height="10" rx="1.5"/><path d="M4 13.5V4h9.5"/></I>,
  trash:       (p) => <I {...p}><path d="M4 5.5h12M8 5.5V4h4v1.5M6 5.5l.6 11h6.8l.6-11M9 8.5v5M11 8.5v5"/></I>,
